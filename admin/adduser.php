...
if(isset($_POST['submit']) && $_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $existsql = "SELECT * FROM users WHERE email = '".$email."' OR phone = '".$phone."'";
...
<section class="main-content">
      ...
      <?php 
      if($showalert){
          echo '<div class="alert alert-success alert-dismissible margin-b-0" role="alert"> <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button> <strong>Success !</strong><br> Your Account is Created now and you can Login.</div>'; 
    }
    if($showerror){
                ...
                <div class="card-body">
                      <form class="form-horizontal" id="signupForm1" novalidate="novalidate" method="POST">
                        ...
                        <div class="form-group">
                              ...
                              <input type="text" maxlength="10" minlength="10" class="form-control" id="phone" name="phone" placeholder="phone" />
                        </div>
